...
export default function ServiceIcon({ name, size = 22, color = 'currentColor' }: ServiceIconProps) {
  ...
  switch (name) {
    ...
    case 'car':
      return <svg {...props}><path d="M5 17H3a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v9a2 2 0 0 1-2 2h-2"/><circle cx="7.5" cy="17.5" r="2.5"/><circle cx="17.5" cy="17.5" r="2.5"/></svg>
    case 'home':
    ...
    case 'road':
      return <svg {...props}><polyline points="5 17 12 3 19 17"/><polyline points="7.5 13.5 16.5 13.5"/><line x1="12" y1="3" x2="12" y2="21"/></svg>
    case 'drafting-compass':
      return <svg {...props}><circle cx="12" cy="5" r="2"/><path d="M12 7v4"/><path d="m8 21 4-9 4 9"/><path d="M6.5 18.5h11"/></svg>
    default:
